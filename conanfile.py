...
class CombineDataConan(ConanFile):
    """Class to package CombineDataPlugin using conan
    ...
    name = "CombineDataPlugin"
    description = (
        "Plugin that computes means of clusters."
    )
    topics = ("ManiVault", "plugin")
    url = "https://github.com/ManiVaultStudio/CombineDataPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/CombineDataPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/CombineDataPlugin")
        cmake.verbose = True
        return cmake
